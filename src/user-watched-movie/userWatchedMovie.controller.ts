...
export class UserWatchedMovieController {
  ...
  getAllWatchedMoviesIdsByUserId(
  ...
  addWatchedMovieIdToUserByUserId(
    @Param() params: { userId: number; movieId: number },
  ): Promise<void> {
    return this.userWatchedMovieService.addWatchedMovieIdToUserByUserId(
      params.userId,
      params.movieId,
    );
  }
  ...
  removeWatchedMovieIdToUserByUserId(
    @Param() params: { userId: number; movieId: number },
  ): Promise<void> {
    return this.userWatchedMovieService.removeWatchedMovieIdToUserByUserId(
      params.userId,
      params.movieId,
    );
  }
