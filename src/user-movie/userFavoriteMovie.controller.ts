...
export class UserFavoriteMovieController {
  ...
  addMovieIdToUserByUserId(@Param() params: {userId: number, movieId: number}): Promise<void> {
    return this.userFavoriteMovieService.addMovieIdToUserByUserId(params.userId, params.movieId);
  }

  @Delete(":userId/movie/:movieId")
  removeMovieIdToUserByUserId(@Param() params: {userId: number, movieId: number}): Promise<void> {
    return this.userFavoriteMovieService.removeMovieIdToUserByUserId(params.userId, params.movieId);
  }
