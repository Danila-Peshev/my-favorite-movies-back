...
export class UserFavoriteGenreController {
  ...
  addGenreIdToUserByUserId(@Param() params: {userId: number, genreId: number}): Promise<void> {
    return this.userFavoriteGenreService.addGenreIdToUserByUserId(params.userId, params.genreId);
  }

  @Delete(":userId/genre/:genreId")
  removeGenreIdToUserByUserId(@Param() params: {userId: number, genreId: number}): Promise<void> {
    return this.userFavoriteGenreService.removeGenreIdToUserByUserId(params.userId, params.genreId);
  }
